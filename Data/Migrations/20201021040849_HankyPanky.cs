...
{
    public partial class HankyPanky : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Edmonton", 932546, "AB" },
                    { 3, "Red Deer", 100418, "AB" },
                    { 4, "Burnaby", 232755, "BC" },
                    { 5, "Richmond", 198309, "BC" },
                    { 6, "Vancouver", 631486, "BC" },
                    { 7, "Montreal", 1704694, "QC" },
                    { 8, "Mont-Tremblant", 9646, "QC" },
                    { 9, "Saguenay", 145949, "QC" }
                });
